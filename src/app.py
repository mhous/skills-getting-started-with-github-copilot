...
activities = {
    ...
    "Basketball Team": {
        "description": "Basketball practice, drills, and league games",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "james@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Theater acting, stage production, and school play performances",
    ...
    "Science Club": {
        "description": "Hands-on experiments, science fair projects, and STEM exploration",
